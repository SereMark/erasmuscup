...
export default function PrincipleSection({ data }) {
  ...
  return (
    <section ref={sectionRef} className="relative py-12 sm:py-16 md:py-24 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden -z-10">
        ...
        <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-full h-[15rem] sm:h-[25rem] bg-brand-500/5 blur-[100px] rounded-full" />
        <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-full h-[15rem] sm:h-[25rem] bg-accent-500/5 blur-[100px] rounded-full" />
      </div>
      
      <div className="absolute left-0 top-1/2 transform -translate-y-1/2 w-12 sm:w-32 h-full opacity-20 hidden sm:block">
      ...
      <div className="absolute right-0 top-1/2 transform -translate-y-1/2 w-12 sm:w-32 h-full opacity-20 hidden sm:block">
      ...
      >
            ...
            <h2 className="inline-block text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold">
              {titleChars.map((char, i) => (
                <motion.span
                  ...
                  className={char === " " ? "inline-block mr-1 sm:mr-2" : "inline-block text-transparent bg-clip-text bg-gradient-to-r from-brand-300 to-brand-500"}
                >
                  {char === " " ? "\u00A0" : char}
                </motion.span>
              ))}
        ...
        <motion.div variants={textVariants} className="relative glass-card p-5 sm:p-8 md:p-12 pb-10 sm:pb-16 overflow-hidden border border-brand-900/50">
          <div className="text-base sm:text-xl md:text-2xl text-center mb-6 sm:mb-8 leading-relaxed text-gray-200" dangerouslySetInnerHTML={{ __html: data.mainTextHtml }} />
          <div className="text-sm sm:text-base lg:text-lg text-center text-gray-400" dangerouslySetInnerHTML={{ __html: data.secondaryTextHtml }} />
          
          <div className="absolute top-0 right-0 -mt-6 -mr-6 w-16 sm:w-24 h-16 sm:h-24 opacity-20 rotate-12">
          ...
          <div className="absolute bottom-0 left-0 -mb-6 -ml-6 w-16 sm:w-24 h-16 sm:h-24 opacity-20 -rotate-12">
            <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <motion.div variants={textVariants} className="mt-8 sm:mt-12 mx-auto w-16 sm:w-24 h-1 bg-gradient-to-r from-brand-500/0 via-brand-500 to-brand-500/0" />
      </motion.div>
    </section>
  )
}