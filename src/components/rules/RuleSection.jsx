...
const RuleSection = ({ section, terms, isActive }) => {
  ...
  return (
    <motion.div
      ...
      className={`mb-12 pb-10 border-b border-dark-800/30 scroll-mt-28 ${
        isActive ? 'relative' : ''
      }`}
    >
      ...
      <div className="flex items-center mb-6 group">
        ...
        {isAmended && (
          <div className="ml-auto">
            <span className="badge-accent py-1 px-2 text-xs">
              Amended
            </span>
          </div>
        )}
      ...
      >
        ...
        {isAmended && (
          <motion.div 
            className="mt-6 p-5 rounded-lg bg-dark-800/50 border-l-4 border-accent-500"
          ...
          >
            <div className="flex items-start">
              ...
              <div>
                <h4 className="text-accent-400 font-semibold text-sm mb-1">Amendment of April 4, 2025</h4>
