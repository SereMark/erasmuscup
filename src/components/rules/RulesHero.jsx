...
/**
 * Hero component for the rules page
 */
    ...
    <section className="relative py-12 sm:py-16 md:py-20 lg:py-24 overflow-hidden bg-dark-900">
      ...
      <div className="absolute inset-0" aria-hidden="true">
        ...
        <motion.div 
          ...
          variants={floatingBlob2Variants}
          animate="animate"
        />
      </div>
      ...
      {/* Gradient divider */}
      <div className="absolute bottom-0 left-0 w-full h-12 sm:h-16" aria-hidden="true">
